...
$similar_sql = "SELECT * FROM moi WHERE id != ? ORDER BY RAND() LIMIT 4";
...
<div class="product-detail-container">
  <div class="product-main">
    <div class="product-gallery">
      <div class="gallery-wrapper">
        <div class="thumbnails-vertical">
          <img src="<?php echo htmlspecialchars($product['hanh_nb'] ?? 'default_image.jpg'); ?>" 
               onclick="changeImage(this)" 
               data-src="<?php echo htmlspecialchars($product['hanh_nb'] ?? 'default_image.jpg'); ?>" 
               class="thumbnail-img active" />
          <?php if (!empty($product['imgct1'])): ?>
            <img src="<?php echo htmlspecialchars($product['imgct1']); ?>" 
                 onclick="changeImage(this)" 
                 data-src="<?php echo htmlspecialchars($product['imgct1']); ?>" 
                 class="thumbnail-img" />
          <?php endif; ?>
          <?php if (!empty($product['imgct2'])): ?>
            <img src="<?php echo htmlspecialchars($product['imgct2']); ?>" 
                 onclick="changeImage(this)" 
                 data-src="<?php echo htmlspecialchars($product['imgct2']); ?>" 
                 class="thumbnail-img" />
          <?php endif; ?>
          <?php if (!empty($product['imgct3'])): ?>
            <img src="<?php echo htmlspecialchars($product['imgct3']); ?>" 
                 onclick="changeImage(this)" 
                 data-src="<?php echo htmlspecialchars($product['imgct3']); ?>" 
                 class="thumbnail-img" />
          <?php endif; ?>
        </div>
        ...
        <div class="main-image-wrapper">
          ...
          <img id="mainPreview" 
               src="<?php echo htmlspecialchars($product['hanh_nb'] ?? 'default_image.jpg'); ?>" 
               alt="<?php echo htmlspecialchars($product['ten_nb'] ?? 'Product'); ?>" 
    ...
    <div class="product-info-section">
      ...
      <h1 class="product-title"><?php echo htmlspecialchars($product['ten_nb'] ?? 'Sản phẩm'); ?></h1>
      
      <p class="product-description"><?php echo htmlspecialchars($product['mota_nb'] ?? 'Mô tả không có'); ?></p>
      ...
      <div class="product-price">
        <?php echo number_format($product['gia_nb'] ?? 0, 0, ',', '.'); ?>₫
      </div>
      ...
      <form method="POST" class="product-form">
        ...
        <input type="hidden" name="gh_name" value="<?php echo htmlspecialchars($product['ten_nb'] ?? ''); ?>" />
        <input type="hidden" name="img" value="<?php echo htmlspecialchars($product['hanh_nb'] ?? 'default_image.jpg'); ?>" />
        <input type="hidden" name="price" value="<?php echo htmlspecialchars($product['gia_nb'] ?? 0); ?>" />
    ...
    <div class="similar-grid">
      <?php while ($similar_product = $similar_result->fetch_assoc()): ?>
        <div class="similar-product-card">
          <img src="<?php echo htmlspecialchars($similar_product['hanh_nb'] ?? 'default_image.jpg'); ?>" 
               alt="<?php echo htmlspecialchars($similar_product['ten_nb'] ?? 'Product'); ?>" 
               class="similar-product-image" />
          <div class="similar-product-info">
            <h3 class="similar-product-title"><?php echo htmlspecialchars($similar_product['ten_nb'] ?? 'Sản phẩm'); ?></h3>
            <div class="similar-product-price">
              <?php echo number_format($similar_product['gia_nb'] ?? 0, 0, ',', '.'); ?>₫
            </div>
            <button class="similar-product-btn" onclick="window.location.href='?go=add_to_cart&id=<?php echo $similar_product['id']; ?>'">
              Xem chi tiết
            </button>
          </div>
        </div>
