            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <h1 class="text-2xl font-bold text-gray-900">Giày Nữ</h1>
                    </div>
                </div>
            ...
            <div class="grid-container">
                ...
                ?>
                    <div class="product-card animate-fade-in bg-white rounded-2xl overflow-hidden shadow-sm" style="animation-delay: <?= $counter * 0.1 ?>s">
                        ...
                        <!-- Product Image -->
                        <a href="?go=add_to_cart_nu&id=<?= $row['id'] ?>" class="block">
                        ...
                        <!-- Product Info -->
                        <div class="p-4">
                            <h3 class="product-title text-lg mb-2"><?= $row['ten_nu'] ?></h3>
                            
                            <div class="flex items-center justify-between mb-3">
                                <div class="price-badge px-3 py-1 rounded-full text-sm">
                                    <?= number_format($row['gia_nu'], 0, ',', '.') ?>₫
                                </div>
                            ...
                            <p class="text-sm text-gray-600 line-clamp-2 mb-4"><?= $row['mota_nu'] ?></p>
